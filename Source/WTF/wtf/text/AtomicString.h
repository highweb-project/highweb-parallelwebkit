...
public:
    ...
    ALWAYS_INLINE static PassRefPtr<StringImpl> addIdentifier(StringTableProvider& stringTableProvider, const char* s) { return addIdentifier(stringTableProvider, reinterpret_cast<const LChar*>(s)); };

    template<typename StringTableProvider>
    ALWAYS_INLINE static PassRefPtr<StringImpl> addIdentifier(StringTableProvider& stringTableProvider, const char* s, unsigned length) { return addIdentifier(stringTableProvider, reinterpret_cast<const LChar*>(s), length); };

    template<typename StringTableProvider>
    ALWAYS_INLINE static PassRefPtr<StringImpl> addIdentifier(StringTableProvider& stringTableProvider, const LChar* c)
    {
        return addSlowCase(*stringTableProvider.atomicStringTable(), c);
    }

    template<typename StringTableProvider>
    ALWAYS_INLINE static PassRefPtr<StringImpl> addIdentifier(StringTableProvider& stringTableProvider, const LChar* s, unsigned length)
    {
        return addSlowCase(*stringTableProvider.atomicStringTable(), s, length);
    }

    template<typename StringTableProvider>
    ALWAYS_INLINE static PassRefPtr<StringImpl> addIdentifier(StringTableProvider& stringTableProvider, const UChar* s, unsigned length)
    {
        return addSlowCase(*stringTableProvider.atomicStringTable(), s, length);
    }

    template<typename StringTableProvider>
    ALWAYS_INLINE static PassRefPtr<StringImpl> addIdentifier(StringTableProvider& stringTableProvider, const UChar* s)
    {
        return addSlowCase(*stringTableProvider.atomicStringTable(), s);
    }

    template<typename StringTableProvider>
    ALWAYS_INLINE static PassRefPtr<StringImpl> addIdentifier(StringTableProvider& stringTableProvider, StringImpl* string)
    {
        if (!string || string->isAtomic()) {
            ASSERT_WITH_MESSAGE(!string || !string->length() || isInStringProviderTable(*stringTableProvider.atomicStringTable(), string), "The atomic string comes from an other thread!");
            return string;
        }
...
private:
...
#if ENABLE(VMOLAB)
    WTF_EXPORT_STRING_API static PassRefPtr<StringImpl> addSlowCase(AtomicStringTable&, const LChar*);
    WTF_EXPORT_STRING_API static PassRefPtr<StringImpl> addSlowCase(AtomicStringTable&, const LChar*, unsigned);
    WTF_EXPORT_STRING_API static PassRefPtr<StringImpl> addSlowCase(AtomicStringTable&, const UChar*, unsigned);
    WTF_EXPORT_STRING_API static PassRefPtr<StringImpl> addSlowCase(AtomicStringTable&, const UChar*);
#endif
    ...
    WTF_EXPORT_STRING_API static bool isInStringProviderTable(AtomicStringTable&, StringImpl*);
#endif
};
