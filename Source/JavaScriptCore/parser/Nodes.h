...
namespace JSC {
    ...
    protected:
#if ENABLE(VMOLAB)
        ParserArenaRefCounted(VM*, ParserArena* parserArena);
#else
...
#if ENABLE(VMOLAB)
        ScopeNode(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, bool inStrictContext);
        ScopeNode(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, const SourceCode&, SourceElements*, VarStack*, FunctionStack*, IdentifierSet&, CodeFeatures, int numConstants);
#else
...
#if ENABLE(VMOLAB)
        static PassRefPtr<ProgramNode> create(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, unsigned startColumn, unsigned endColumn, SourceElements*, VarStack*, FunctionStack*, IdentifierSet&, const SourceCode&, CodeFeatures, int numConstants);
#else
    ...
    private:
#if ENABLE(VMOLAB)
        ProgramNode(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, unsigned startColumn, unsigned endColumn, SourceElements*, VarStack*, FunctionStack*, IdentifierSet&, const SourceCode&, CodeFeatures, int numConstants);
#else
    ...
    public:
        static const bool isFunctionNode = false;
#if ENABLE(VMOLAB)
        static PassRefPtr<EvalNode> create(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, unsigned, unsigned endColumn, SourceElements*, VarStack*, FunctionStack*, IdentifierSet&, const SourceCode&, CodeFeatures, int numConstants);
#else
    ...
    private:
#if ENABLE(VMOLAB)
        EvalNode(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, unsigned endColumn, SourceElements*, VarStack*, FunctionStack*, IdentifierSet&, const SourceCode&, CodeFeatures, int numConstants);
#else
...
#if ENABLE(VMOLAB)
        static FunctionBodyNode* create(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, unsigned startColumn, unsigned endColumn, bool isStrictMode);
        static PassRefPtr<FunctionBodyNode> create(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, unsigned startColumn, unsigned endColumn, SourceElements*, VarStack*, FunctionStack*, IdentifierSet&, const SourceCode&, CodeFeatures, int numConstants);
#else
    ...
    private:
#if ENABLE(VMOLAB)
        FunctionBodyNode(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, unsigned startColumn, unsigned endColumn, bool inStrictContext);
        FunctionBodyNode(VM*, ParserArena*, const JSTokenLocation& start, const JSTokenLocation& end, unsigned startColumn, unsigned endColumn, SourceElements*, VarStack*, FunctionStack*, IdentifierSet&, const SourceCode&, CodeFeatures, int numConstants);
#else
